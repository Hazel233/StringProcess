...
The goal of this package is to develop some functions to process strings.
...
`cutcertainstr`: Reduce and cut a given string into parts with a fixed length.

**Warning**: `cutcertainstr` relies on `strsplit` and `delete_na`. Don't download it separately.


## Assignment5 - STAT545B - New update for version 0.1.1

In this version 0.1.1, two new functions for string processing are added to realize more functions.
If you want to know more about what changes has been made here, please refer to `version 0.1.0` tag.
